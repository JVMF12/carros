    ...
    <main className="min-h-svh bg-off-white-bg py-20 px-6">
      ...
      <section>
        <div className="bg-orange">
          ...
          <a href="https://www.webmotors.com.br/sedans " className="font-lexend" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-green">
            ...
            <a href="https://www.webmotors.com.br/suvs"  className="font-lexend" target="_blank">Ver mais</a>
        </div>

           
        <div className="bg-dark-green">
            <img src={iconLuxo} alt="" />
            ...
            <a href="https://www.webmotors.com.br/carros-de-luxo" className="font-lexend" target="_blank">Ver mais</a>
        </div>
      </section>
